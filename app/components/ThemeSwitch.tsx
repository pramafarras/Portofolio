...
export default function ThemeSwitch(){
    ...
    return (
        <div onClick={() => switchTheme()} className="left-8 bottom-8 fixed cursor-pointer bg-dark hover:bg-secondary dark:bg-primary dark:hover:bg-amber-400 p-3 rounded-full">
        {resolvedTheme === 'dark'
